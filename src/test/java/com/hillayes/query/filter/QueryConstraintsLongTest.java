 ...
 * @since 1.0.0
 */
public class QueryConstraintsLongTest
{
    ...
    {
        fixture.setFilter("propertyA EQ 9223372036854775808");
    ...
    {
        fixture.setFilter("propertyA eq 100");
    ...
    {
        fixture.setFilter("propertyB eq 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    public void testIsNull() throws Exception
    {
        ...
        verify(statement, never()).setLong(anyInt(), anyByte());
    ...
    {
        fixture.setFilter("propertyA ne 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    {
        fixture.setFilter("propertyA lt 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    {
        fixture.setFilter("propertyA le 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    {
        fixture.setFilter("propertyA ge 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    {
        fixture.setFilter("propertyA gt 100");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
