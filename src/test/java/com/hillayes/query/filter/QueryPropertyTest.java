...
public class QueryPropertyTest {
    ...
    public void testToTypeString() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", String.class);
    ...
    public void testToType_boolean() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", boolean.class);
    ...
    public void testToTypeByte() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Byte.class);
    ...
    public void testToTypeInteger() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Integer.class);
    ...
    public void testToTypeInt() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", int.class);
    ...
    public void testToTypeLong() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Long.class);
    ...
    public void testToTypeBigInteger() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", BigInteger.class);
    ...
    public void testToTypeBigDecimal() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", BigDecimal.class);
    ...
    public void testToTypeDouble() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Double.class);
    ...
    public void testToTypeFloat() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Float.class);
    ...
    public void testToTypeCalendar() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Calendar.class);
    ...
    public void testToTypeDate() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", Date.class);
    ...
    public void testToTypeSqlDate() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", java.sql.Date.class);
    ...
    public void testToTypeTime() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", java.sql.Time.class);
    ...
    public void testToTypeTimestamp() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", java.sql.Timestamp.class);
    ...
    public void testToTypeUUID() throws Exception {
        ...
        QueryProperty fixture = new QueryProperty("name", "col_name", UUID.class);
