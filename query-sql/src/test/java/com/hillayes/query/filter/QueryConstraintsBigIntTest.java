 ...
 * @since 1.0.0
 */
public class QueryConstraintsBigIntTest {
    ...
    public void testPositive() throws Exception {
        fixture.setFilter("propertyA eq 999999999999");
    ...
    public void testNotEq() throws Exception {
        fixture.setFilter("propertyA ne 999999999999");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    public void testLessThan() throws Exception {
        fixture.setFilter("propertyA lt 999999999999");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    public void testLessThanEqual() throws Exception {
        fixture.setFilter("propertyA le 999999999999");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    public void testGreaterThanEqual() throws Exception {
        fixture.setFilter("propertyA ge 999999999999");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
    ...
    public void testGreaterThan() throws Exception {
        fixture.setFilter("propertyA gt 999999999999");
        PreparedStatement statement = fixture.prepareStatement(mockConnection, "select x from table");
        assertNotNull(statement);
