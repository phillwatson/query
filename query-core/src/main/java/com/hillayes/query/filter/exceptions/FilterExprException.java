 ...
 * @since 28 Aug 2018
 */
public class FilterExprException extends FilterException {
    public FilterExprException(String aFilterExpr) {
        this(aFilterExpr, null);
    }

    public FilterExprException(String aFilterExpr, Throwable aCause) {
